...
public class UserProfileController {
  ...
  //create 
  @PostMapping("create")
   public ResponseEntity<String> createAnUserProfile(@PathVariable UserProfile userProfile ){
  ...
  public ResponseEntity<UserProfile> getAnUserProfile(@PathVariable Long userId){
  ...
  public void deleteAnUserProfile(@PathVariable Long userId) {
